...
double FEM<dim>::basis_function(unsigned int node, double xi){
 ...
 //}
  ...
  /* Using if statement to construct basis function with basisFunctionOrder=1 */
  if (basisFunctionOrder == 1) {
    
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b)
  {
        value = (xi - xi_at_node(0))*(xi - xi_at_node(1))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1));
  }
  if(xi_at_node(0) == xi_b && xi_at_node(1) != xi_b)
  {
        value = (xi - xi_at_node(1))/(xi_b-xi_at_node(1));
  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) == xi_b)
  {
        value = (xi - xi_at_node(0))/(xi_b-xi_at_node(0));
  }
  
  }
    
  /* Using if statement to construct basis function with basisFunctionOrder=2 */
  if (basisFunctionOrder == 2) {

  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b && xi_at_node(2) != xi_b)
  {
        value = (xi - xi_at_node(0))*(xi - xi_at_node(1))*(xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2));
  }
  if(xi_at_node(0) == xi_b && xi_at_node(1) != xi_b && xi_at_node(2) != xi_b)
  {
        value = (xi - xi_at_node(1))*(xi - xi_at_node(2))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2));
  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) == xi_b && xi_at_node(2) != xi_b)
  {
        value = (xi - xi_at_node(0))*(xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(2));
  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b && xi_at_node(2) == xi_b)
  {
        value = (xi - xi_at_node(0))*(xi - xi_at_node(1))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1));
  ...
  /* Using if statement to construct basis function with basisFunctionOrder=3 */
  if (basisFunctionOrder == 3) {
      
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b && xi_at_node(2) != xi_b && xi_at_node(3) != xi_b)
  {
        value = (xi - xi_at_node(0))*(xi - xi_at_node(1))*(xi - xi_at_node(2))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3));
  }
      
  if(xi_at_node(0) == xi_b && xi_at_node(1) != xi_b && xi_at_node(2) != xi_b && xi_at_node(3) != xi_b)
  {
        value = (xi - xi_at_node(1))*(xi - xi_at_node(2))*(xi - xi_at_node(3))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3));
  }
      
  if(xi_at_node(0) != xi_b && xi_at_node(1) == xi_b && xi_at_node(2) != xi_b && xi_at_node(3) != xi_b)
  {
        value = (xi - xi_at_node(0))*(xi - xi_at_node(2))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3));
  }
      
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b && xi_at_node(2) == xi_b && xi_at_node(3) != xi_b)
  {
        value = (xi - xi_at_node(0))*(xi - xi_at_node(1))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(3));
  }
...
double FEM<dim>::basis_gradient(unsigned int node, double xi){
 ...
 //}
  ...
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b)
  {
        value = (xi - xi_at_node(1))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1)) + (xi - xi_at_node(0))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1));
  }
  if(xi_at_node(0) == xi_b && xi_at_node(1) != xi_b)
  {
        value = 1./(xi_b-xi_at_node(1));
  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) == xi_b)
  {
        value = 1./(xi_b-xi_at_node(0));
  }
  ...
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b && xi_at_node(2) != xi_b)
  {
        value = (xi - xi_at_node(1))*(xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2)) + (xi - xi_at_node(0))*(xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2)) + (xi - xi_at_node(0))*(xi - xi_at_node(1))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2));
  }
  if(xi_at_node(0) == xi_b && xi_at_node(1) != xi_b && xi_at_node(2) != xi_b)
  {
        value = (xi - xi_at_node(2))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2)) + (xi - xi_at_node(1))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2));
  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) == xi_b && xi_at_node(2) != xi_b)
  {
        value = (xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(2)) + (xi - xi_at_node(0))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(2));
  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b && xi_at_node(2) == xi_b)
  {
        value = (xi - xi_at_node(1))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1)) + (xi - xi_at_node(0))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1));
  ...
  {
        value =
      (xi - xi_at_node(1))*(xi - xi_at_node(2))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(0))*(xi - xi_at_node(2))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(0))*(xi - xi_at_node(1))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(0))*(xi - xi_at_node(1))*(xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3));
  }
  if(xi_at_node(0) == xi_b && xi_at_node(1) != xi_b && xi_at_node(2) != xi_b && xi_at_node(3) != xi_b)
  {
         value =
      (xi - xi_at_node(2))*(xi - xi_at_node(3))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(1))*(xi - xi_at_node(3))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(1))*(xi - xi_at_node(2))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3));
  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) == xi_b && xi_at_node(2) != xi_b && xi_at_node(3) != xi_b)
  {
         value =
      (xi - xi_at_node(2))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(0))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(0))*(xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(2))/(xi_b-xi_at_node(3));

  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b && xi_at_node(2) == xi_b && xi_at_node(3) != xi_b)
  {
         value =
      (xi - xi_at_node(1))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(0))*(xi - xi_at_node(3))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(3))
      +(xi - xi_at_node(0))*(xi - xi_at_node(1))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(3));

  }
  if(xi_at_node(0) != xi_b && xi_at_node(1) != xi_b && xi_at_node(2) != xi_b && xi_at_node(3) == xi_b)
  {
      value =
      (xi - xi_at_node(1))*(xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))
      +(xi - xi_at_node(0))*(xi - xi_at_node(2))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2))
      +(xi - xi_at_node(0))*(xi - xi_at_node(1))/(xi_b-xi_at_node(0))/(xi_b-xi_at_node(1))/(xi_b-xi_at_node(2));
